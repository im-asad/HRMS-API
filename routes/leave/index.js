...
module.exports = (sequelize) => {
    ...
    router.post("/request", async (req,res)=>{
        ...
        let employee = await models.Employee.findOne({where:{
    ...
    router.put("/request", async(req,res)=>{
        ...
        let request = await models.LeaveRequest.findOne({where: {
        ...
        if (req.body.data.status === "declined"){
            ...
            await employee.update({leaveBalance: employee.leaveBalance + 1});
